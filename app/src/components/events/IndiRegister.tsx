...
export default async function IndiRegister({ event }: { event: any }) {
                    ...
                    <div className="w-full">
                        <Card className=" max-w-3xl mx-auto">
                            ...
                            <CardContent>
                                ...
                                <p className="mb-2">If any correction, please edit your profile</p>
                            </CardContent>
                        </Card>

                        <div className="flex justify-end max-w-3xl mx-auto mt-5">
                            <RegisterButton event={event} user={user} />
                        </div>
                    </div>
                </main>
            </div>
